...
def log_result(C,best_val_b1,best_val_b2,best_val_b3,best_val_b4,best_val_rl,best_val_cider,best_val_acc_sw,best_val_acc_c,best_val_bfs,best_val_cfs):
    log_path = os.path.join( C.log_dpath, "logs.csv")
    with open(log_path, 'a') as fout:
        fout.write(str([best_val_b1,best_val_b2,best_val_b3,best_val_b4,best_val_rl,best_val_cider,best_val_acc_sw,best_val_acc_c,best_val_bfs,best_val_cfs])+"\n")
...
def main():
    ...
    for e in range(1, C.epochs + 1):
        ...
        scores, refs, hypos, vid2idx = score_full(model,em_test_iter,vocab)
        ...
        print(best_val_b1,best_val_b2,best_val_b3,best_val_b4,best_val_rl,best_val_cider,best_val_acc_sw,best_val_acc_c,best_val_bfs,best_val_cfs)
        log_result(C,best_val_b1,best_val_b2,best_val_b3,best_val_b4,best_val_rl,best_val_cider,best_val_acc_sw,best_val_acc_c,best_val_bfs,best_val_cfs)
