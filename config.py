...
class MSVDLoaderConfig:
    ...
    em_train_caption_fpath = "dataset/EmVidCap-L/EmVideo_trainval_captions.csv"
    em_test_caption_fpath = "dataset/EmVidCap-L/EmVideo_test_captions.csv"
    ...
    split_video_feat_fpath_tpl_em = "dataset/EmVidCap-L/features/{}_{}.hdf5"

    split_negative_vids_fpath = "dataset/MSVD/metadata/neg_vids_{}.json" 
    split_negative_emvids_fpath = "dataset/MSVD/metadata/L_v2v/neg_Emvids_{}_L.json" 
...
class Config:
    ...
    pretrained_fpath = "/home/yec/Video_Cap/EPAN-main_subj/checkpoints/EmVidCap-L/11.ckpt"
    vocab = VocabConfig
