...
class CustomVocab(object):
    def __init__(self, caption_fpath, init_word2idx, min_count=1, transform=str.split, embedding_size=300,
        ...
        self.em2idx = {}
        self.em_cates = []
        ems = open('dataset/34_emotion.txt','r')
    ...
    def load_pretrained_embedding(self, name):
        if name == 'GloVe':
            ...
            with open("dataset/embeddings/GloVe/GloVe_300.json", 'r') as fin:
                w2v = json.load(fin)
        elif name == 'Word2Vec':
            w2v = gensim.models.KeyedVectors.load_word2vec_format(
                'dataset/embeddings/Word2Vec/GoogleNews-vectors-negative300.bin',
                binary=True)
        else:
...
class CustomDataset(Dataset):
    ...
    def __init__(self, C, split, caption_fpath, transform_frame=None, transform_caption=None,transform_em_word=None, transform_em=None):
        ...
        self.msvd_captions = defaultdict(lambda: [])
        self.em_set = []
        em_words = open('dataset/179_words.txt','r')
        for ddd in em_words:
            em_word = ddd.split()[0]
    ...
    def word2emo(self):
        ...
        main_path = 'dataset/sentiment-words-E/'
    ...
    def build_video_caption_pairs(self):
        ...
        for pos_idx, pos_vid in enumerate(vids):
            ...
            if len(pos_vid)>=8:
                ...
                neg_vids = self.vid2neg_vids[vid2fpth[pos_vid]]
            ...
            for pos_caption in self.captions[pos_vid]:
                ...
                neg_caption = random.choice(self.msvd_captions[neg_vid])
                self.data.append((
